...
from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import FieldComponents
from typing import Optional, Type, Any
from common import vcprint

@dataclass
class FieldComponentsDTO(BaseDTO):
    id: str

    async def _initialize_dto(self, field_components_item):
        '''Override the base initialization method.'''
        self.id = str(field_components_item.id)
        await self._process_core_data(field_components_item)
        await self._process_metadata(field_components_item)
        await self._initial_validation(field_components_item)
        self.initialized = True

    async def _process_core_data(self, field_components_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, field_components_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, field_components_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[FieldComponentsDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class FieldComponentsBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or FieldComponentsDTO
        super().__init__(FieldComponents, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, field_components):
        pass

    async def create_field_components(self, **data):
        return await self.create_item(**data)

    async def delete_field_components(self, id):
        return await self.delete_item(id)

    async def get_field_components_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_field_components_by_id(self, id):
        return await self.load_by_id(id)

    async def load_field_components(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_field_components(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_field_component(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_field_component(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_field_components_with_data_broker(self, id):
        return await self.get_item_with_related(id, 'data_broker')

    async def get_field_component_with_data_broker(self):
        return await self.get_items_with_related('data_broker')

    async def get_field_components_with_container_fields(self, id):
        return await self.get_item_with_related(id, 'container_fields')

    async def get_field_component_with_container_fields(self):
        return await self.get_items_with_related('container_fields')

    async def get_field_components_with_workflow_user_input(self, id):
        return await self.get_item_with_related(id, 'workflow_user_input')

    async def get_field_component_with_workflow_user_input(self):
        return await self.get_items_with_related('workflow_user_input')

    async def load_field_component_by_user_id(self, user_id):
        return await self.load_items(user_id=user_id)

    async def filter_field_component_by_user_id(self, user_id):
        return await self.filter_items(user_id=user_id)

    async def load_field_component_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_field_components_ids(self):
        return self.active_item_ids



class FieldComponentsManager(FieldComponentsBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(FieldComponentsManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

field_components_manager_instance = FieldComponentsManager()
...
from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import Workflow
from typing import Optional, Type, Any
from common import vcprint
...
class WorkflowDTO(BaseDTO):
    ...
    async def _initialize_dto(self, workflow_item):
        '''Override the base initialization method.'''
        self.id = str(workflow_item.id)
        await self._process_core_data(workflow_item)
        await self._process_metadata(workflow_item)
        await self._initial_validation(workflow_item)
        self.initialized = True

    async def _process_core_data(self, workflow_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, workflow_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, workflow_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[WorkflowDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class WorkflowBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or WorkflowDTO
        super().__init__(Workflow, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, workflow):
        pass
    ...
    async def get_workflow_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_workflow_by_id(self, id):
        return await self.load_by_id(id)

    async def load_workflow(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_workflow(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_workflows(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_workflows(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_workflow_with_workflow_node(self, id):
        return await self.get_item_with_related(id, 'workflow_node')

    async def get_workflows_with_workflow_node(self):
        return await self.get_items_with_related('workflow_node')

    async def get_workflow_with_workflow_edge(self, id):
        return await self.get_item_with_related(id, 'workflow_edge')

    async def get_workflows_with_workflow_edge(self):
        return await self.get_items_with_related('workflow_edge')

    async def get_workflow_with_workflow_relay(self, id):
        return await self.get_item_with_related(id, 'workflow_relay')

    async def get_workflows_with_workflow_relay(self):
        return await self.get_items_with_related('workflow_relay')

    async def get_workflow_with_workflow_user_input(self, id):
        return await self.get_item_with_related(id, 'workflow_user_input')

    async def get_workflows_with_workflow_user_input(self):
        return await self.get_items_with_related('workflow_user_input')

    async def load_workflows_by_user_id(self, user_id):
        return await self.load_items(user_id=user_id)

    async def filter_workflows_by_user_id(self, user_id):
        return await self.filter_items(user_id=user_id)

    async def load_workflows_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
...
class DataBrokerBase(BaseManager):
    ...
    async def get_data_broker_with_field_components(self, id):
        return await self.get_item_with_related(id, 'field_components')

    async def get_data_brokers_with_field_components(self):
        return await self.get_items_with_related('field_components')
    ...
    async def get_data_broker_with_registered_function(self, id):
        return await self.get_item_with_related(id, 'registered_function')

    async def get_data_brokers_with_registered_function(self):
    ...
    async def load_data_brokers_by_field_component_id(self, field_component_id):
        return await self.load_items(field_component_id=field_component_id)

    async def filter_data_brokers_by_field_component_id(self, field_component_id):
        return await self.filter_items(field_component_id=field_component_id)

    async def load_data_brokers_by_user_id(self, user_id):
        return await self.load_items(user_id=user_id)

    async def filter_data_brokers_by_user_id(self, user_id):
        return await self.filter_items(user_id=user_id)
...
class RegisteredFunctionBase(BaseManager):
    ...
    async def get_registered_function_with_data_broker(self, id):
        return await self.get_item_with_related(id, 'data_broker')

    async def get_registered_functions_with_data_broker(self):
        return await self.get_items_with_related('data_broker')
    ...
    async def get_registered_function_with_workflow_node(self, id):
        return await self.get_item_with_related(id, 'workflow_node')

    async def get_registered_functions_with_workflow_node(self):
        return await self.get_items_with_related('workflow_node')
    ...
    async def load_registered_functions_by_category(self, category):
        return await self.load_items(category=category)

    async def filter_registered_functions_by_category(self, category):
        return await self.filter_items(category=category)

    async def load_registered_functions_by_icon(self, icon):
        return await self.load_items(icon=icon)

    async def filter_registered_functions_by_icon(self, icon):
        return await self.filter_items(icon=icon)
...
class TasksBase(BaseManager):
    ...
    async def load_task_by_user_id(self, user_id):
        return await self.load_items(user_id=user_id)

    async def filter_task_by_user_id(self, user_id):
        return await self.filter_items(user_id=user_id)
...
from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import ComponentGroups
from typing import Optional, Type, Any
from common import vcprint

@dataclass
class ComponentGroupsDTO(BaseDTO):
    id: str

    async def _initialize_dto(self, component_groups_item):
        '''Override the base initialization method.'''
        self.id = str(component_groups_item.id)
        await self._process_core_data(component_groups_item)
        await self._process_metadata(component_groups_item)
        await self._initial_validation(component_groups_item)
        self.initialized = True

    async def _process_core_data(self, component_groups_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, component_groups_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, component_groups_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[ComponentGroupsDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class ComponentGroupsBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or ComponentGroupsDTO
        super().__init__(ComponentGroups, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, component_groups):
        pass

    async def create_component_groups(self, **data):
        return await self.create_item(**data)

    async def delete_component_groups(self, id):
        return await self.delete_item(id)

    async def get_component_groups_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_component_groups_by_id(self, id):
        return await self.load_by_id(id)

    async def load_component_groups(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_component_groups(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_component_group(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_component_group(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_component_groups_with_applet_containers(self, id):
        return await self.get_item_with_related(id, 'applet_containers')

    async def get_component_group_with_applet_containers(self):
        return await self.get_items_with_related('applet_containers')

    async def get_component_groups_with_container_fields(self, id):
        return await self.get_item_with_related(id, 'container_fields')

    async def get_component_group_with_container_fields(self):
        return await self.get_items_with_related('container_fields')

    async def load_component_group_by_user_id(self, user_id):
        return await self.load_items(user_id=user_id)

    async def filter_component_group_by_user_id(self, user_id):
        return await self.filter_items(user_id=user_id)

    async def load_component_group_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_component_groups_ids(self):
        return self.active_item_ids



class ComponentGroupsManager(ComponentGroupsBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(ComponentGroupsManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

component_groups_manager_instance = ComponentGroupsManager()
...
class SubcategoryBase(BaseManager):
    ...
    async def get_subcategory_with_custom_applet_configs(self, id):
        return await self.get_item_with_related(id, 'custom_applet_configs')

    async def get_subcategories_with_custom_applet_configs(self):
        return await self.get_items_with_related('custom_applet_configs')
...
from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import CustomAppConfigs
from typing import Optional, Type, Any
from common import vcprint

@dataclass
class CustomAppConfigsDTO(BaseDTO):
    id: str

    async def _initialize_dto(self, custom_app_configs_item):
        '''Override the base initialization method.'''
        self.id = str(custom_app_configs_item.id)
        await self._process_core_data(custom_app_configs_item)
        await self._process_metadata(custom_app_configs_item)
        await self._initial_validation(custom_app_configs_item)
        self.initialized = True

    async def _process_core_data(self, custom_app_configs_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, custom_app_configs_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, custom_app_configs_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[CustomAppConfigsDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class CustomAppConfigsBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or CustomAppConfigsDTO
        super().__init__(CustomAppConfigs, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, custom_app_configs):
        pass

    async def create_custom_app_configs(self, **data):
        return await self.create_item(**data)

    async def delete_custom_app_configs(self, id):
        return await self.delete_item(id)

    async def get_custom_app_configs_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_custom_app_configs_by_id(self, id):
        return await self.load_by_id(id)

    async def load_custom_app_configs(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_custom_app_configs(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_custom_app_config(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_custom_app_config(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_custom_app_configs_with_custom_applet_configs(self, id):
        return await self.get_item_with_related(id, 'custom_applet_configs')

    async def get_custom_app_config_with_custom_applet_configs(self):
        return await self.get_items_with_related('custom_applet_configs')

    async def load_custom_app_config_by_user_id(self, user_id):
        return await self.load_items(user_id=user_id)

    async def filter_custom_app_config_by_user_id(self, user_id):
        return await self.filter_items(user_id=user_id)

    async def load_custom_app_config_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_custom_app_configs_ids(self):
        return self.active_item_ids



class CustomAppConfigsManager(CustomAppConfigsBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(CustomAppConfigsManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

custom_app_configs_manager_instance = CustomAppConfigsManager()


from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import CustomAppletConfigs
from typing import Optional, Type, Any
from common import vcprint

@dataclass
class CustomAppletConfigsDTO(BaseDTO):
    id: str

    async def _initialize_dto(self, custom_applet_configs_item):
        '''Override the base initialization method.'''
        self.id = str(custom_applet_configs_item.id)
        await self._process_core_data(custom_applet_configs_item)
        await self._process_metadata(custom_applet_configs_item)
        await self._initial_validation(custom_applet_configs_item)
        self.initialized = True

    async def _process_core_data(self, custom_applet_configs_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, custom_applet_configs_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, custom_applet_configs_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[CustomAppletConfigsDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class CustomAppletConfigsBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or CustomAppletConfigsDTO
        super().__init__(CustomAppletConfigs, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, custom_applet_configs):
        pass

    async def create_custom_applet_configs(self, **data):
        return await self.create_item(**data)

    async def delete_custom_applet_configs(self, id):
        return await self.delete_item(id)

    async def get_custom_applet_configs_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_custom_applet_configs_by_id(self, id):
        return await self.load_by_id(id)

    async def load_custom_applet_configs(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_custom_applet_configs(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_custom_applet_config(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_custom_applet_config(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_custom_applet_configs_with_custom_app_configs(self, id):
        return await self.get_item_with_related(id, 'custom_app_configs')

    async def get_custom_applet_config_with_custom_app_configs(self):
        return await self.get_items_with_related('custom_app_configs')

    async def get_custom_applet_configs_with_compiled_recipe(self, id):
        return await self.get_item_with_related(id, 'compiled_recipe')

    async def get_custom_applet_config_with_compiled_recipe(self):
        return await self.get_items_with_related('compiled_recipe')

    async def get_custom_applet_configs_with_subcategory(self, id):
        return await self.get_item_with_related(id, 'subcategory')

    async def get_custom_applet_config_with_subcategory(self):
        return await self.get_items_with_related('subcategory')

    async def get_custom_applet_configs_with_applet_containers(self, id):
        return await self.get_item_with_related(id, 'applet_containers')

    async def get_custom_applet_config_with_applet_containers(self):
        return await self.get_items_with_related('applet_containers')

    async def load_custom_applet_config_by_user_id(self, user_id):
        return await self.load_items(user_id=user_id)

    async def filter_custom_applet_config_by_user_id(self, user_id):
        return await self.filter_items(user_id=user_id)

    async def load_custom_applet_config_by_compiled_recipe_id(self, compiled_recipe_id):
        return await self.load_items(compiled_recipe_id=compiled_recipe_id)

    async def filter_custom_applet_config_by_compiled_recipe_id(self, compiled_recipe_id):
        return await self.filter_items(compiled_recipe_id=compiled_recipe_id)

    async def load_custom_applet_config_by_subcategory_id(self, subcategory_id):
        return await self.load_items(subcategory_id=subcategory_id)

    async def filter_custom_applet_config_by_subcategory_id(self, subcategory_id):
        return await self.filter_items(subcategory_id=subcategory_id)

    async def load_custom_applet_config_by_app_id(self, app_id):
        return await self.load_items(app_id=app_id)

    async def filter_custom_applet_config_by_app_id(self, app_id):
        return await self.filter_items(app_id=app_id)

    async def load_custom_applet_config_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_custom_applet_configs_ids(self):
        return self.active_item_ids



class CustomAppletConfigsManager(CustomAppletConfigsBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(CustomAppletConfigsManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

custom_applet_configs_manager_instance = CustomAppletConfigsManager()
...
from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import UserLists
from typing import Optional, Type, Any
from common import vcprint

@dataclass
class UserListsDTO(BaseDTO):
    id: str

    async def _initialize_dto(self, user_lists_item):
        '''Override the base initialization method.'''
        self.id = str(user_lists_item.id)
        await self._process_core_data(user_lists_item)
        await self._process_metadata(user_lists_item)
        await self._initial_validation(user_lists_item)
        self.initialized = True

    async def _process_core_data(self, user_lists_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, user_lists_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, user_lists_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[UserListsDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class UserListsBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or UserListsDTO
        super().__init__(UserLists, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, user_lists):
        pass

    async def create_user_lists(self, **data):
        return await self.create_item(**data)

    async def delete_user_lists(self, id):
        return await self.delete_item(id)

    async def get_user_lists_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_user_lists_by_id(self, id):
        return await self.load_by_id(id)

    async def load_user_lists(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_user_lists(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_user_list(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_user_list(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_user_lists_with_user_list_items(self, id):
        return await self.get_item_with_related(id, 'user_list_items')

    async def get_user_list_with_user_list_items(self):
        return await self.get_items_with_related('user_list_items')

    async def load_user_list_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_user_lists_ids(self):
        return self.active_item_ids



class UserListsManager(UserListsBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(UserListsManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

user_lists_manager_instance = UserListsManager()
...
from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import AppletContainers
from typing import Optional, Type, Any
from common import vcprint

@dataclass
class AppletContainersDTO(BaseDTO):
    id: str

    async def _initialize_dto(self, applet_containers_item):
        '''Override the base initialization method.'''
        self.id = str(applet_containers_item.id)
        await self._process_core_data(applet_containers_item)
        await self._process_metadata(applet_containers_item)
        await self._initial_validation(applet_containers_item)
        self.initialized = True

    async def _process_core_data(self, applet_containers_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, applet_containers_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, applet_containers_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[AppletContainersDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class AppletContainersBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or AppletContainersDTO
        super().__init__(AppletContainers, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, applet_containers):
        pass

    async def create_applet_containers(self, **data):
        return await self.create_item(**data)

    async def delete_applet_containers(self, id):
        return await self.delete_item(id)

    async def get_applet_containers_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_applet_containers_by_id(self, id):
        return await self.load_by_id(id)

    async def load_applet_containers(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_applet_containers(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_applet_container(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_applet_container(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_applet_containers_with_custom_applet_configs(self, id):
        return await self.get_item_with_related(id, 'custom_applet_configs')

    async def get_applet_container_with_custom_applet_configs(self):
        return await self.get_items_with_related('custom_applet_configs')

    async def get_applet_containers_with_component_groups(self, id):
        return await self.get_item_with_related(id, 'component_groups')

    async def get_applet_container_with_component_groups(self):
        return await self.get_items_with_related('component_groups')

    async def load_applet_container_by_applet_id(self, applet_id):
        return await self.load_items(applet_id=applet_id)

    async def filter_applet_container_by_applet_id(self, applet_id):
        return await self.filter_items(applet_id=applet_id)

    async def load_applet_container_by_container_id(self, container_id):
        return await self.load_items(container_id=container_id)

    async def filter_applet_container_by_container_id(self, container_id):
        return await self.filter_items(container_id=container_id)

    async def load_applet_container_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_applet_containers_ids(self):
        return self.active_item_ids



class AppletContainersManager(AppletContainersBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(AppletContainersManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

applet_containers_manager_instance = AppletContainersManager()
...
from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import ContainerFields
from typing import Optional, Type, Any
from common import vcprint

@dataclass
class ContainerFieldsDTO(BaseDTO):
    id: str

    async def _initialize_dto(self, container_fields_item):
        '''Override the base initialization method.'''
        self.id = str(container_fields_item.id)
        await self._process_core_data(container_fields_item)
        await self._process_metadata(container_fields_item)
        await self._initial_validation(container_fields_item)
        self.initialized = True

    async def _process_core_data(self, container_fields_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, container_fields_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, container_fields_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[ContainerFieldsDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class ContainerFieldsBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or ContainerFieldsDTO
        super().__init__(ContainerFields, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, container_fields):
        pass

    async def create_container_fields(self, **data):
        return await self.create_item(**data)

    async def delete_container_fields(self, id):
        return await self.delete_item(id)

    async def get_container_fields_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_container_fields_by_id(self, id):
        return await self.load_by_id(id)

    async def load_container_fields(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_container_fields(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_container_field(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_container_field(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_container_fields_with_component_groups(self, id):
        return await self.get_item_with_related(id, 'component_groups')

    async def get_container_field_with_component_groups(self):
        return await self.get_items_with_related('component_groups')

    async def get_container_fields_with_field_components(self, id):
        return await self.get_item_with_related(id, 'field_components')

    async def get_container_field_with_field_components(self):
        return await self.get_items_with_related('field_components')

    async def load_container_field_by_field_id(self, field_id):
        return await self.load_items(field_id=field_id)

    async def filter_container_field_by_field_id(self, field_id):
        return await self.filter_items(field_id=field_id)

    async def load_container_field_by_container_id(self, container_id):
        return await self.load_items(container_id=container_id)

    async def filter_container_field_by_container_id(self, container_id):
        return await self.filter_items(container_id=container_id)

    async def load_container_field_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_container_fields_ids(self):
        return self.active_item_ids



class ContainerFieldsManager(ContainerFieldsBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(ContainerFieldsManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

container_fields_manager_instance = ContainerFieldsManager()
...
from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import HtmlExtractions
from typing import Optional, Type, Any
from common import vcprint

@dataclass
class HtmlExtractionsDTO(BaseDTO):
    id: str

    async def _initialize_dto(self, html_extractions_item):
        '''Override the base initialization method.'''
        self.id = str(html_extractions_item.id)
        await self._process_core_data(html_extractions_item)
        await self._process_metadata(html_extractions_item)
        await self._initial_validation(html_extractions_item)
        self.initialized = True

    async def _process_core_data(self, html_extractions_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, html_extractions_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, html_extractions_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[HtmlExtractionsDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class HtmlExtractionsBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or HtmlExtractionsDTO
        super().__init__(HtmlExtractions, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, html_extractions):
        pass

    async def create_html_extractions(self, **data):
        return await self.create_item(**data)

    async def delete_html_extractions(self, id):
        return await self.delete_item(id)

    async def get_html_extractions_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_html_extractions_by_id(self, id):
        return await self.load_by_id(id)

    async def load_html_extractions(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_html_extractions(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_html_extraction(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_html_extraction(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def load_html_extraction_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_html_extractions_ids(self):
        return self.active_item_ids



class HtmlExtractionsManager(HtmlExtractionsBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(HtmlExtractionsManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

html_extractions_manager_instance = HtmlExtractionsManager()
...
from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import Prompts
from typing import Optional, Type, Any
from common import vcprint
...
from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import SchemaTemplates
from typing import Optional, Type, Any
from common import vcprint

@dataclass
class SchemaTemplatesDTO(BaseDTO):
    id: str

    async def _initialize_dto(self, schema_templates_item):
        '''Override the base initialization method.'''
        self.id = str(schema_templates_item.id)
        await self._process_core_data(schema_templates_item)
        await self._process_metadata(schema_templates_item)
        await self._initial_validation(schema_templates_item)
        self.initialized = True

    async def _process_core_data(self, schema_templates_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, schema_templates_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, schema_templates_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[SchemaTemplatesDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class SchemaTemplatesBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or SchemaTemplatesDTO
        super().__init__(SchemaTemplates, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, schema_templates):
        pass

    async def create_schema_templates(self, **data):
        return await self.create_item(**data)

    async def delete_schema_templates(self, id):
        return await self.delete_item(id)

    async def get_schema_templates_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_schema_templates_by_id(self, id):
        return await self.load_by_id(id)

    async def load_schema_templates(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_schema_templates(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_schema_template(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_schema_template(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def load_schema_template_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_schema_templates_ids(self):
        return self.active_item_ids



class SchemaTemplatesManager(SchemaTemplatesBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(SchemaTemplatesManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

schema_templates_manager_instance = SchemaTemplatesManager()
...
from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import UserListItems
from typing import Optional, Type, Any
from common import vcprint

@dataclass
class UserListItemsDTO(BaseDTO):
    id: str

    async def _initialize_dto(self, user_list_items_item):
        '''Override the base initialization method.'''
        self.id = str(user_list_items_item.id)
        await self._process_core_data(user_list_items_item)
        await self._process_metadata(user_list_items_item)
        await self._initial_validation(user_list_items_item)
        self.initialized = True

    async def _process_core_data(self, user_list_items_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, user_list_items_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, user_list_items_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[UserListItemsDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class UserListItemsBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or UserListItemsDTO
        super().__init__(UserListItems, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, user_list_items):
        pass

    async def create_user_list_items(self, **data):
        return await self.create_item(**data)

    async def delete_user_list_items(self, id):
        return await self.delete_item(id)

    async def get_user_list_items_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_user_list_items_by_id(self, id):
        return await self.load_by_id(id)

    async def load_user_list_items(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_user_list_items(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_user_list_item(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_user_list_item(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_user_list_items_with_user_lists(self, id):
        return await self.get_item_with_related(id, 'user_lists')

    async def get_user_list_item_with_user_lists(self):
        return await self.get_items_with_related('user_lists')

    async def load_user_list_item_by_user_id(self, user_id):
        return await self.load_items(user_id=user_id)

    async def filter_user_list_item_by_user_id(self, user_id):
        return await self.filter_items(user_id=user_id)

    async def load_user_list_item_by_list_id(self, list_id):
        return await self.load_items(list_id=list_id)

    async def filter_user_list_item_by_list_id(self, list_id):
        return await self.filter_items(list_id=list_id)

    async def load_user_list_item_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_user_list_items_ids(self):
        return self.active_item_ids



class UserListItemsManager(UserListItemsBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(UserListItemsManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

user_list_items_manager_instance = UserListItemsManager()
...
from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import WorkflowEdge
from typing import Optional, Type, Any
from common import vcprint
...
class WorkflowEdgeDTO(BaseDTO):
    ...
    async def _initialize_dto(self, workflow_edge_item):
        '''Override the base initialization method.'''
        self.id = str(workflow_edge_item.id)
        await self._process_core_data(workflow_edge_item)
        await self._process_metadata(workflow_edge_item)
        await self._initial_validation(workflow_edge_item)
        self.initialized = True

    async def _process_core_data(self, workflow_edge_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, workflow_edge_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, workflow_edge_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[WorkflowEdgeDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class WorkflowEdgeBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or WorkflowEdgeDTO
        super().__init__(WorkflowEdge, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, workflow_edge):
        pass

    async def create_workflow_edge(self, **data):
        return await self.create_item(**data)

    async def delete_workflow_edge(self, id):
        return await self.delete_item(id)

    async def get_workflow_edge_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_workflow_edge_by_id(self, id):
        return await self.load_by_id(id)

    async def load_workflow_edge(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_workflow_edge(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_workflow_edges(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_workflow_edges(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_workflow_edge_with_workflow(self, id):
        return await self.get_item_with_related(id, 'workflow')

    async def get_workflow_edges_with_workflow(self):
        return await self.get_items_with_related('workflow')

    async def load_workflow_edges_by_workflow_id(self, workflow_id):
        return await self.load_items(workflow_id=workflow_id)

    async def filter_workflow_edges_by_workflow_id(self, workflow_id):
        return await self.filter_items(workflow_id=workflow_id)

    async def load_workflow_edges_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_workflow_edge_ids(self):
        return self.active_item_ids



class WorkflowEdgeManager(WorkflowEdgeBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(WorkflowEdgeManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

workflow_edge_manager_instance = WorkflowEdgeManager()


from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import WorkflowNode
from typing import Optional, Type, Any
from common import vcprint
...
class WorkflowNodeDTO(BaseDTO):
    ...
    async def _initialize_dto(self, workflow_node_item):
        '''Override the base initialization method.'''
        self.id = str(workflow_node_item.id)
        await self._process_core_data(workflow_node_item)
        await self._process_metadata(workflow_node_item)
        await self._initial_validation(workflow_node_item)
        self.initialized = True

    async def _process_core_data(self, workflow_node_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, workflow_node_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, workflow_node_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[WorkflowNodeDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class WorkflowNodeBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or WorkflowNodeDTO
        super().__init__(WorkflowNode, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, workflow_node):
        pass

    async def create_workflow_node(self, **data):
        return await self.create_item(**data)

    async def delete_workflow_node(self, id):
        return await self.delete_item(id)

    async def get_workflow_node_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_workflow_node_by_id(self, id):
        return await self.load_by_id(id)

    async def load_workflow_node(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_workflow_node(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_workflow_nodes(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_workflow_nodes(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_workflow_node_with_registered_function(self, id):
        return await self.get_item_with_related(id, 'registered_function')

    async def get_workflow_nodes_with_registered_function(self):
        return await self.get_items_with_related('registered_function')

    async def get_workflow_node_with_workflow(self, id):
        return await self.get_item_with_related(id, 'workflow')

    async def get_workflow_nodes_with_workflow(self):
        return await self.get_items_with_related('workflow')

    async def load_workflow_nodes_by_user_id(self, user_id):
        return await self.load_items(user_id=user_id)

    async def filter_workflow_nodes_by_user_id(self, user_id):
        return await self.filter_items(user_id=user_id)

    async def load_workflow_nodes_by_workflow_id(self, workflow_id):
        return await self.load_items(workflow_id=workflow_id)

    async def filter_workflow_nodes_by_workflow_id(self, workflow_id):
        return await self.filter_items(workflow_id=workflow_id)

    async def load_workflow_nodes_by_function_id(self, function_id):
        return await self.load_items(function_id=function_id)

    async def filter_workflow_nodes_by_function_id(self, function_id):
        return await self.filter_items(function_id=function_id)

    async def load_workflow_nodes_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_workflow_node_ids(self):
        return self.active_item_ids



class WorkflowNodeManager(WorkflowNodeBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(WorkflowNodeManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

workflow_node_manager_instance = WorkflowNodeManager()


from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import WorkflowRelay
from typing import Optional, Type, Any
from common import vcprint

@dataclass
class WorkflowRelayDTO(BaseDTO):
    id: str

    async def _initialize_dto(self, workflow_relay_item):
        '''Override the base initialization method.'''
        self.id = str(workflow_relay_item.id)
        await self._process_core_data(workflow_relay_item)
        await self._process_metadata(workflow_relay_item)
        await self._initial_validation(workflow_relay_item)
        self.initialized = True

    async def _process_core_data(self, workflow_relay_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, workflow_relay_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, workflow_relay_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[WorkflowRelayDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class WorkflowRelayBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or WorkflowRelayDTO
        super().__init__(WorkflowRelay, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, workflow_relay):
        pass

    async def create_workflow_relay(self, **data):
        return await self.create_item(**data)

    async def delete_workflow_relay(self, id):
        return await self.delete_item(id)

    async def get_workflow_relay_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_workflow_relay_by_id(self, id):
        return await self.load_by_id(id)

    async def load_workflow_relay(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_workflow_relay(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_workflow_relays(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_workflow_relays(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_workflow_relay_with_workflow(self, id):
        return await self.get_item_with_related(id, 'workflow')

    async def get_workflow_relays_with_workflow(self):
        return await self.get_items_with_related('workflow')

    async def load_workflow_relays_by_workflow_id(self, workflow_id):
        return await self.load_items(workflow_id=workflow_id)

    async def filter_workflow_relays_by_workflow_id(self, workflow_id):
        return await self.filter_items(workflow_id=workflow_id)

    async def load_workflow_relays_by_user_id(self, user_id):
        return await self.load_items(user_id=user_id)

    async def filter_workflow_relays_by_user_id(self, user_id):
        return await self.filter_items(user_id=user_id)

    async def load_workflow_relays_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_workflow_relay_ids(self):
        return self.active_item_ids



class WorkflowRelayManager(WorkflowRelayBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(WorkflowRelayManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

workflow_relay_manager_instance = WorkflowRelayManager()


from dataclasses import dataclass
from database.orm.core.extended import BaseManager, BaseDTO
from database.orm.models import WorkflowUserInput
from typing import Optional, Type, Any
from common import vcprint

@dataclass
class WorkflowUserInputDTO(BaseDTO):
    id: str

    async def _initialize_dto(self, workflow_user_input_item):
        '''Override the base initialization method.'''
        self.id = str(workflow_user_input_item.id)
        await self._process_core_data(workflow_user_input_item)
        await self._process_metadata(workflow_user_input_item)
        await self._initial_validation(workflow_user_input_item)
        self.initialized = True

    async def _process_core_data(self, workflow_user_input_item):
        '''Process core data from the model item.'''
        pass

    async def _process_metadata(self, workflow_user_input_item):
        '''Process metadata from the model item.'''
        pass

    async def _initial_validation(self, workflow_user_input_item):
        '''Validate fields from the model item.'''
        pass
    ...
    async def get_validated_dict(self):
        ...
        dict_data = self.to_dict()
        if not validated:
            vcprint(dict_data, "[WorkflowUserInputDTO] Validation Failed", verbose=True, pretty=True, color="red")
        return dict_data



class WorkflowUserInputBase(BaseManager):
    def __init__(self, dto_class: Optional[Type[Any]] = None):
        self.dto_class = dto_class or WorkflowUserInputDTO
        super().__init__(WorkflowUserInput, self.dto_class)

    def _initialize_manager(self):
        super()._initialize_manager()

    async def _initialize_runtime_data(self, workflow_user_input):
        pass

    async def create_workflow_user_input(self, **data):
        return await self.create_item(**data)

    async def delete_workflow_user_input(self, id):
        return await self.delete_item(id)

    async def get_workflow_user_input_with_all_related(self, id):
        return await self.get_item_with_all_related(id)

    async def load_workflow_user_input_by_id(self, id):
        return await self.load_by_id(id)

    async def load_workflow_user_input(self, use_cache=True, **kwargs):
        return await self.load_item(use_cache, **kwargs)

    async def update_workflow_user_input(self, id, **updates):
        return await self.update_item(id, **updates)

    async def exists(self, id):
        return await self.exists(id)

    async def load_workflow_user_inputs(self, **kwargs):
        return await self.load_items(**kwargs)

    async def filter_workflow_user_inputs(self, **kwargs):
        return await self.filter_items(**kwargs)

    async def get_or_create(self, defaults=None, **kwargs):
        return await self.get_or_create(defaults, **kwargs)

    async def get_workflow_user_input_with_field_components(self, id):
        return await self.get_item_with_related(id, 'field_components')

    async def get_workflow_user_inputs_with_field_components(self):
        return await self.get_items_with_related('field_components')

    async def get_workflow_user_input_with_workflow(self, id):
        return await self.get_item_with_related(id, 'workflow')

    async def get_workflow_user_inputs_with_workflow(self):
        return await self.get_items_with_related('workflow')

    async def load_workflow_user_inputs_by_workflow_id(self, workflow_id):
        return await self.load_items(workflow_id=workflow_id)

    async def filter_workflow_user_inputs_by_workflow_id(self, workflow_id):
        return await self.filter_items(workflow_id=workflow_id)

    async def load_workflow_user_inputs_by_user_id(self, user_id):
        return await self.load_items(user_id=user_id)

    async def filter_workflow_user_inputs_by_user_id(self, user_id):
        return await self.filter_items(user_id=user_id)

    async def load_workflow_user_inputs_by_field_component_id(self, field_component_id):
        return await self.load_items(field_component_id=field_component_id)

    async def filter_workflow_user_inputs_by_field_component_id(self, field_component_id):
        return await self.filter_items(field_component_id=field_component_id)

    async def load_workflow_user_inputs_by_ids(self, ids):
        return await self.load_items_by_ids(ids)
    ...
    @property
    def active_workflow_user_input_ids(self):
        return self.active_item_ids



class WorkflowUserInputManager(WorkflowUserInputBase):
    _instance = None

    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(WorkflowUserInputManager, cls).__new__(cls)
        return cls._instance

    def __init__(self):
        super().__init__()

workflow_user_input_manager_instance = WorkflowUserInputManager()