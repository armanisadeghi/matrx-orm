...
field_components_auto_config = {'model_pascal': 'FieldComponents', 'model_name': 'field_components', 'model_name_plural': 'field_component', 'model_name_snake': 'field_components', 'relations': ['data_broker', 'container_fields', 'workflow_user_input'], 'filter_fields': ['user_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
workflow_auto_config = {'model_pascal': 'Workflow', 'model_name': 'workflow', 'model_name_plural': 'workflows', 'model_name_snake': 'workflow', 'relations': ['workflow_node', 'workflow_edge', 'workflow_relay', 'workflow_user_input'], 'filter_fields': ['user_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
data_broker_auto_config = {'model_pascal': 'DataBroker', 'model_name': 'data_broker', 'model_name_plural': 'data_brokers', 'model_name_snake': 'data_broker', 'relations': ['data_input_component', 'field_components', 'data_output_component', 'broker_value', 'message_broker', 'registered_function'], 'filter_fields': ['data_type', 'input_component', 'color', 'output_component', 'field_component_id', 'user_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
registered_function_auto_config = {'model_pascal': 'RegisteredFunction', 'model_name': 'registered_function', 'model_name_plural': 'registered_functions', 'model_name_snake': 'registered_function', 'relations': ['data_broker', 'system_function', 'arg', 'workflow_node'], 'filter_fields': ['return_broker', 'category', 'icon'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
broker_auto_config = {'model_pascal': 'Broker', 'model_name': 'broker', 'model_name_plural': 'brokers', 'model_name_snake': 'broker', 'relations': ['data_input_component', 'recipe_broker', 'automation_boundary_broker'], 'filter_fields': ['data_type', 'default_source', 'custom_source_component', 'default_destination', 'output_component'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
component_groups_auto_config = {'model_pascal': 'ComponentGroups', 'model_name': 'component_groups', 'model_name_plural': 'component_group', 'model_name_snake': 'component_groups', 'relations': ['applet_containers', 'container_fields'], 'filter_fields': ['user_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
subcategory_auto_config = {'model_pascal': 'Subcategory', 'model_name': 'subcategory', 'model_name_plural': 'subcategories', 'model_name_snake': 'subcategory', 'relations': ['category', 'applet', 'custom_applet_configs'], 'filter_fields': ['category_id', 'features'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
custom_app_configs_auto_config = {'model_pascal': 'CustomAppConfigs', 'model_name': 'custom_app_configs', 'model_name_plural': 'custom_app_config', 'model_name_snake': 'custom_app_configs', 'relations': ['custom_applet_configs'], 'filter_fields': ['user_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}


custom_applet_configs_auto_config = {'model_pascal': 'CustomAppletConfigs', 'model_name': 'custom_applet_configs', 'model_name_plural': 'custom_applet_config', 'model_name_snake': 'custom_applet_configs', 'relations': ['custom_app_configs', 'compiled_recipe', 'subcategory', 'applet_containers'], 'filter_fields': ['user_id', 'compiled_recipe_id', 'subcategory_id', 'app_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
user_lists_auto_config = {'model_pascal': 'UserLists', 'model_name': 'user_lists', 'model_name_plural': 'user_list', 'model_name_snake': 'user_lists', 'relations': ['user_list_items'], 'filter_fields': [], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
applet_containers_auto_config = {'model_pascal': 'AppletContainers', 'model_name': 'applet_containers', 'model_name_plural': 'applet_container', 'model_name_snake': 'applet_containers', 'relations': ['custom_applet_configs', 'component_groups'], 'filter_fields': ['applet_id', 'container_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
container_fields_auto_config = {'model_pascal': 'ContainerFields', 'model_name': 'container_fields', 'model_name_plural': 'container_field', 'model_name_snake': 'container_fields', 'relations': ['component_groups', 'field_components'], 'filter_fields': ['field_id', 'container_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
html_extractions_auto_config = {'model_pascal': 'HtmlExtractions', 'model_name': 'html_extractions', 'model_name_plural': 'html_extraction', 'model_name_snake': 'html_extractions', 'relations': [], 'filter_fields': [], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
prompts_auto_config = {'model_pascal': 'Prompts', 'model_name': 'prompts', 'model_name_plural': 'prompt', 'model_name_snake': 'prompts', 'relations': [], 'filter_fields': ['user_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
schema_templates_auto_config = {'model_pascal': 'SchemaTemplates', 'model_name': 'schema_templates', 'model_name_plural': 'schema_template', 'model_name_snake': 'schema_templates', 'relations': [], 'filter_fields': [], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
user_list_items_auto_config = {'model_pascal': 'UserListItems', 'model_name': 'user_list_items', 'model_name_plural': 'user_list_item', 'model_name_snake': 'user_list_items', 'relations': ['user_lists'], 'filter_fields': ['user_id', 'list_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}
...
workflow_edge_auto_config = {'model_pascal': 'WorkflowEdge', 'model_name': 'workflow_edge', 'model_name_plural': 'workflow_edges', 'model_name_snake': 'workflow_edge', 'relations': ['workflow'], 'filter_fields': ['workflow_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}


workflow_node_auto_config = {'model_pascal': 'WorkflowNode', 'model_name': 'workflow_node', 'model_name_plural': 'workflow_nodes', 'model_name_snake': 'workflow_node', 'relations': ['registered_function', 'workflow'], 'filter_fields': ['user_id', 'workflow_id', 'function_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}


workflow_relay_auto_config = {'model_pascal': 'WorkflowRelay', 'model_name': 'workflow_relay', 'model_name_plural': 'workflow_relays', 'model_name_snake': 'workflow_relay', 'relations': ['workflow'], 'filter_fields': ['workflow_id', 'user_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}


workflow_user_input_auto_config = {'model_pascal': 'WorkflowUserInput', 'model_name': 'workflow_user_input', 'model_name_plural': 'workflow_user_inputs', 'model_name_snake': 'workflow_user_input', 'relations': ['field_components', 'workflow'], 'filter_fields': ['workflow_id', 'user_id', 'field_component_id'], 'include_core_relations': True, 'include_active_relations': False, 'include_filter_fields': True, 'include_active_methods': False, 'include_or_not_methods': False, 'include_to_dict_methods': False, 'include_to_dict_relations': False}